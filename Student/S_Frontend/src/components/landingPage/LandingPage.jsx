          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4">
              <div
                ...
                data-wow-delay=".2s"
              >
                <h1 className="mb-5 text-3xl font-bold leading-tight text-black sm:text-4xl sm:leading-tight md:text-4xl md:leading-tight">
                ...
                <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                  ...
                  onClick={handleSignIn}
                    href="link here"
                    className="px-8 py-2 text-base text-4xl text-white bg-black rounded-md hover:bg-primary"
                  >
                   Start 
