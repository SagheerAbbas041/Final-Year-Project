...
const[consoleOutput,setConsole_output] = useState('');
  ...
  const handleSubmit = () => {
    ...
    const deploymentResponse = simulateDeployment(githubLink, selectedTool,projectData.ProjectId);
  ...
  return (
   ...
   {loading ? (
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mt-6">
          <h2 className="text-3xl font-extrabold text-center text-gray-900">Frontend Deployment Manager</h2>
