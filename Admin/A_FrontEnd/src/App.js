...
import {ContainerManager} from './components/dockerContainer/manageContainer'
    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/home" element={<Statisticshome />} />
          ...
          <Route path="/manageContainers" element={<ContainerManager />} />
